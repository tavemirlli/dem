...
CREATE DATABASE IF NOT EXISTS demo2026;
USE demo2026;
...
CREATE TABLE IF NOT EXISTS user (
    ...
    role ENUM('Администратор', 'Менеджер', 'Пользователь') NOT NULL
);

-- Таблица товаров
CREATE TABLE IF NOT EXISTS tovar (
    tovar_id INT PRIMARY KEY AUTO_INCREMENT,
    picture VARCHAR(255) DEFAULT 'picture.png',
...
CREATE TABLE IF NOT EXISTS punkt (
    punkt_id INT PRIMARY KEY AUTO_INCREMENT,
    adress VARCHAR(200) NOT NULL
);

-- Добавляем тестовые данные
INSERT INTO user (name, login, password, role) VALUES 
('Иван Петров', 'admin', '123', 'Администратор'),
('Мария Сидорова', 'manager', '123', 'Менеджер'),
('Гость', 'guest', '123', 'Пользователь');

INSERT INTO tovar (category, name, description, maker, diler, price, metric, stock, discount, article) VALUES 
('Кроссовки', 'Nike Air Max', 'Спортивные кроссовки', 'Nike', 'ООО Спорт', 7500, 'пара', 25, 10, 'NIKE-001'),
('Ботинки', 'Timberland', 'Кожаные ботинки', 'Timberland', 'ИП Иванов', 12000, 'пара', 5, 0, 'TIMB-001'),
('Сандалии', 'ECCO', 'Летние сандалии', 'ECCO', 'ООО Обувь', 4500, 'пара', 0, 20, 'ECCO-001');

INSERT INTO punkt (adress) VALUES 
('Москва, ул. Тверская, д.1'),
('СПб, Невский пр., д.10');


UPDATE tovar SET picture = 'nike.jpg' WHERE article = 'NIKE-001';